...
import { CheckCircleOutline, EmergencyRecordingOutlined, PersonOutlined, RunCircleOutlined, UploadFileOutlined } from '@mui/icons-material';
...
const BottomNavigation = () => (
  ...
  >
    ...
    <NavigationButton title="Members" path="/admin/members" icon={<UploadFileOutlined />} />
