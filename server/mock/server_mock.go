...
//
//	mockgen -source=server.go -destination=mock/server_mock.go -package=mock
//
...
func (m *MockopenSessionRepo) MarkAttendanceIsIgnored(id, reason string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MarkAttendanceIsIgnored", id, reason)
	ret0, _ := ret[0].(error)
	return ret0
}

// MarkAttendanceIsIgnored indicates an expected call of MarkAttendanceIsIgnored.
func (mr *MockopenSessionRepoMockRecorder) MarkAttendanceIsIgnored(id, reason any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkAttendanceIsIgnored", reflect.TypeOf((*MockopenSessionRepo)(nil).MarkAttendanceIsIgnored), id, reason)
}
